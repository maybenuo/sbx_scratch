...
var assetUrlParts = ["http://"+window.location.host+"/", 'scratch/play/project/', assetIdParts[0]];
if (assetIdParts[1]) {assetUrlParts.push(assetIdParts[1]);}
return assetUrlParts.join('');
};
//项目资源文件下载URL
function getAssetUrl(asset) {
var assetUrlParts = ["http://"+window.location.host+"/", 'scratch/assets/', asset.assetId, '.', asset.dataFormat];
return assetUrlParts.join('');
};
